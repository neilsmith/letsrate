module Helpers
  def rating_for(rateable_obj, dimension=nil, options={})
    ...
    readonly = !(current_website_user && rateable_obj.can_rate?(current_website_user, dimension))
  ...
  def rating_for_user(rateable_obj, rating_user, dimension = nil, options = {})
    ...
    if disable_after_rate
      readonly = current_website_user.present? ? !rateable_obj.can_rate?(current_website_user.id, dimension) : true
    end
